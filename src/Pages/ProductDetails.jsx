...
const ProductDetails = () => {
  ...
  const handleImportSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.insertedId) {
        ...
        await axiosSecure.patch(`/products/import/${product._id}`, {
          quantity: parseInt(quantity),
        });
  ...
  //   fetch("https://global-hub-server.vercel.app/imports", {
  //   method: "POST",
  ...
  //       fetch(`https://global-hub-server.vercel.app/products/import/${product._id}`, {
  //         method: "PATCH",
  //         headers: { "content-type": "application/json" },
  //         body: JSON.stringify({
  //           quantity: parseInt(quantity),
      ...
      <div className="py-12">
        ...
        <div className="mt-12 bg-base-200/40 backdrop-blur-lg border border-base-300  rounded-2xl p-8 shadow-lg">
          ...
          <p className="text-gray-400 leading-relaxed">
            ...
            demanded across global markets. Importers can confidently source
            this product for wholesale distribution, retail businesses, or
            industrial use. Reliable supply chain and high quality make this
            product an excellent choice for international trade.
          </p>
        </div>
